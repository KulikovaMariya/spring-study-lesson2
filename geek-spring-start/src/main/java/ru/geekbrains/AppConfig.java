...
@Configuration
@ComponentScan({"ru.geekbrains.springdata", "ru.geekbrains.entity"})
@PropertySource("classpath:application.properties")
@EnableJpaRepositories(basePackages = {"ru.geekbrains.springdata.repository"})
public class AppConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/online-store");
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManager() {
        ...
        factory.setPackagesToScan("ru.geekbrains");
